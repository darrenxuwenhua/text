...
class ajax extends AWS_CONTROLLER
{
    ...
    public function modify_question_action()
    {
		...
		$imgPath = 'uploads/fox/';
		$imgUrl= '/uploads/fox/';
		$path_url= get_setting('upload_dir') . '/fox/';
		...
		//$body=preg_replace("/\\[url=(http:\\/\\/.+?)\\](.+?)\\[\\/url\\]/is","\\2",$body);
		}

        $this->model('question')->update_question($question_info['question_id'], $_POST['question_content'], $body, $this->user_id, $IS_MODIFY_VERIFIED, $_POST['modify_reason'], $question_info['anonymous'], $_POST['category_id']);
    ...
    public function publish_question_action()
    {
        ...
        else
        {
            ...
            $question_id = $this->model('publish')->publish_question($_POST['question_content'], $body, $_POST['category_id'], $this->user_id, $_POST['topics'], $_POST['anonymous'], $_POST['attach_access_key'], $_POST['ask_user_id'], $this->user_info['permission']['create_topic']);
    ...
    public function publish_article_action()
    {
        ...
        else
        {
            ...
            $article_id = $this->model('publish')->publish_article($_POST['title'], $body, $this->user_id, $_POST['topics'], $_POST['category_id'], $_POST['attach_access_key'], $this->user_info['permission']['create_topic']);
    ...
    public function modify_article_action()
    {
        ...
        $this->model('article')->update_article($article_info['id'], $_POST['title'], $body, $_POST['topics'], $_POST['category_id'], $this->user_info['permission']['create_topic']);
